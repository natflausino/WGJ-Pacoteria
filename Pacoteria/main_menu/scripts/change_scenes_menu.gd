...
func _on_endday1_pressed():
	get_tree().change_scene_to_file("res://dias/scenes/day2/dia2_1.tscn")

func _on_endday2_pressed():
	get_tree().change_scene_to_file("res://dias/scenes/day3/dia3_1.tscn")

func _on_endgame_pressed():
	get_tree().change_scene_to_file("res://final/scene/final_jogo.tscn")

func _on_start_pressed():
	get_tree().change_scene_to_file("res://dias/scenes/day1/dia1_1.tscn")
